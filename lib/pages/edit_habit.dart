...
class _EditHabitState extends State<EditHabit> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      final db = Provider.of<Sql>(context, listen: false);
      final habits = await db.getaHabits(int.parse(widget.id));
                          ...
                          onTap: () {
                           ...
                           Habit newHabit = new Habit(
                             ...
                             time: DateTime.now(),
                              ...
                              final dbs = context.read<Sql>();
                                dbs.updateHabit(newHabit,int.parse(widget.id));
